...
HD_PWD='C:/Users/JFM/Desktop/Jeen_Nekkit6-master/miriscv_testsoc/miriscv_testsoc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log miriscv_test_soc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source miriscv_test_soc.tcl
