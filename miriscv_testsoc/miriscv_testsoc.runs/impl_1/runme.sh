...
HD_PWD='C:/Users/JFM/Desktop/Jeen_Nekkit6-master/miriscv_testsoc/miriscv_testsoc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log miriscv_test_soc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source miriscv_test_soc.tcl -notrace
